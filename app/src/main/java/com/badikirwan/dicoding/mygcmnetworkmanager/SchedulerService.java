package com.badikirwan.dicoding.mygcmnetworkmanager;
...
public class SchedulerService extends GcmTaskService{
    ...
    public static final String TAG = "GetWaeather";
    private final String APP_ID = "e0b46f05ae800d5e82c685490cb4b47d";
